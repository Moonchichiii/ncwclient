...
By using our services, you acknowledge that you have read and understood these Terms and agree to be bound by them.` // Add your full terms content here
    },
    privacy: {
...
- Address: [Your Business Address]` 
  ...
  return (
    <>
      <footer className="bg-[#6a6969] py-8 sm:py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <nav className="flex flex-col items-center sm:items-start space-y-2">
                {legalLinks.map((link) => (
                  <button
                    ...
                    className="text-gray-300 hover:text-[#CBB26A] transition-colors duration-200 text-sm sm:text-base cursor-pointer text-left"
                  >
                    {link.label}
                  </button>
                ))}
          ...
          <div className="border-t border-gray-700 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center text-sm sm:text-base">
